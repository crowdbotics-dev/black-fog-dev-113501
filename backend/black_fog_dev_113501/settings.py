"""
Django settings for black_fog_dev_113501 project.
...
ROOT_URLCONF = 'black_fog_dev_113501.urls'
...
WSGI_APPLICATION = 'black_fog_dev_113501.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_fog_dev_113501 API",
    "DESCRIPTION": "API documentation for black_fog_dev_113501 App",
    "VERSION": "v1",
}
